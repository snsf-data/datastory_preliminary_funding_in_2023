...
datastory_name <- "preliminary_funding_in_2023"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "preliminary-funding-in-2023"
datastory_name_de <- "vorlaeufige-zahlen-2023"
datastory_name_fr <- "encouragement-2023-donnees-preliminaires"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "235 million francs in grants for transitional measures"
lead_en <- "First preliminary figures: In 2023, the SNSF invested 953 million francs in new projects, fellowships and publications of its regular funding schemes. We awarded a further 235 million for the Horizon Europe transitional measures."
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Übergangsmassnahmen mit 235 Millionen Franken gefördert"
lead_de <- "Erste vorläufige Zahlen: 2023 investierte der SNF 953 Millionen Franken in neue Projekte, Stipendien und Publikationen seiner regulären Förderinstrumente. Weitere 235 Millionen vergaben wir für Horizon-Europe-Übergangsmassnahmen."
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "Mesures transitoires financées à hauteur de 235 millions de francs"
lead_fr <- "Premiers chiffres provisoires : en 2023, le FNS a investi 953 millions de francs dans le cadre de ses instruments d’encouragement réguliers. Nous avons également alloué 235 millions aux mesures transitoires Horizon Europe."
...
publication_date <- "2024-02-27 04:00:00"
...
doi_url <- "https://doi.org/10.46446/datastory.preliminary-funding-in-2023"
